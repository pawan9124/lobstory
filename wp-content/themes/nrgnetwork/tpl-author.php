            ...
            <div class="col-xs-12 col-md-4 left-feild">
                <div class="be-user-block style-3">
                    <div class="be-user-detail">
                        <a class="be-ava-user style-2 img-round" href="javascript:;"><?php print get_avatar( $user, 115 ); ?></a>
                        <?php
                            if( is_user_logged_in() ){
                                if( $user == get_current_user_id() ){
                                    print '<a class="be-ava-left btn color-1 size-2 hover-1" href="'.NRGnetwork_C::get_author_edit_uri($user).'"><i class="fa fa-pencil"></i>'.esc_html__('Edit', 'nrgnetwork').'</a>';
                                } else {
                                    $is_following = NRGnetwork_C::net_is_following($user);
                                    if( $is_following=='following' ){
                                        print '<a href="javascript:;" class="be-ava-left btn color-1 size-2 hover-1 bp-follow-action" data-user-id="'.$user.'" data-text-follow="'.esc_html__('FOLLOW', 'nrgnetwork').'" data-text-following="'.esc_html__('FOLLOWING', 'nrgnetwork').'">'.esc_html__('FOLLOWING', 'nrgnetwork').'</a>';
                                    } else {
                                        print '<a href="javascript:;" class="be-ava-left btn color-1 size-2 hover-1 bp-follow-action" data-user-id="'.$user.'" data-text-follow="'.esc_html__('FOLLOW', 'nrgnetwork').'" data-text-following="'.esc_html__('FOLLOWING', 'nrgnetwork').'"><i class="fa fa-plus"></i>'.esc_html__('FOLLOW', 'nrgnetwork').'</a>';
                                    }
                                }
                            } else {
                                print '<a class="be-ava-left btn color-1 size-2 hover-1 no-logged-in"><i class="fa fa-plus"></i>'.esc_html__('Follow', 'nrgnetwork').'</a>';
                            }
                            if( $user==get_current_user_id() ): ?>
                                <div class="be-ava-right btn btn-share color-4 size-2 hover-7">
                                    ...
                                    <div class="share-buttons author-profile-share">
                                        <?php
                                            $profile_url = NRGnetwork_C::get_author_uri($user);
                                            $profile_name = get_the_author_meta('display_name', $user);
                                        ?>
                                        <a class="color-1" target="_blank" href="http://www.facebook.com/sharer.php?u=<?php print esc_url($profile_url); ?>"><i class="fa fa-facebook"></i></a>
                                        <a class="color-2" target="_blank" href="https://twitter.com/share?url=<?php print esc_url($profile_url); ?>&text=<?php print esc_attr($profile_name); ?>"><i class="fa fa-twitter"></i></a>
                                        <a class="color-3" target="_blank" href="https://pinterest.com/pin/create/bookmarklet/?url=<?php print esc_url($profile_url); ?>&description=<?php print esc_attr($profile_name); ?>"><i class="fa fa-pinterest-p"></i></a>
                                        <a class="color-4" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php print esc_url($profile_url); ?>&title=<?php print esc_attr($profile_name); ?>"><i class="fa fa-linkedin"></i></a>
                                    </div>
                                </div>
                            <?php else: ?>
                            <div class="be-ava-right btn btn-message color-4 size-2 hover-7" data-author="<?php print esc_attr($user_data->ID); ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="hidden" id="msg_username" value="<?php print esc_attr($user_data->ID); ?>">
                        ...
                        <p class="be-use-name">
                            <?php
                                ...
                                if( !empty($fname) || !empty($lname) ){
                                    ...
                                    print get_the_author_meta('display_name', $user);
                                }
                            ?>
                        </p>
                        <div class="be-user-info"><?php print get_user_meta($user, 'cs_city', true) . ', ' . get_user_meta($user, 'cs_country', true); ?></div>
                        ...
                        <div class="be-user-social">
                            <?php
                                ...
                                $cs_socials = NRGnetwork_C::decode($cs_socials_op);
                                ...
                                $index = 1;
                                $socialz = array('facebook', 'twitter', 'google', 'pinterest', 'instagram', 'linkedin');

                                foreach ($socialz as $social):
                                    if( $cs_socials[$social] && $cs_socials[$social] != '' ):
                                        print '<a class="social-btn color-'.$index.'" href="'. esc_attr($cs_socials[$social]) .'"><i class="fa fa-'.$social.'"></i></a> ';
                                    endif;
                                    $index++;
                                endforeach;
                            ?>
                        </div>
                        <a class="be-user-site" href="<?php print get_user_meta($user, 'user_url', true); ?>"><i class="fa fa-link"></i> <?php print get_user_meta($user, 'user_url', true); ?></a>
                    </div>
                    <div class="be-user-statistic">
                        ...
                        <div class="stat-row clearfix">
                            ...
                            <span class="stat-counter"><?php print count($friend_followers); ?></span>
                        </div>
                        <div class="stat-row clearfix">
                            <i class="stat-icon icon-following-b"></i>
                            <?php esc_html_e('Following', 'nrgnetwork'); ?>
                            <span class="stat-counter"><?php print count($following); ?></span>
                        </div>
                    </div>
                </div>
                <div class="be-desc-block">
                    <div class="be-desc-author">
                        ...
                        <div class="be-desc-text"><?php print get_the_author_meta('description', $user); ?>
                        </div>
                    </div>
                    <?php
                    ...
                    ?>
                        <div class="be-desc-author">
                            ...
                            <div class="clearfix"></div>
                            <div class="be-desc-text"><?php printf('%s', $item['content']); ?></div>
                        </div>
                    <?php endforeach; ?>
                </div>                                      
            </div>
                ...
                <div class="tab-wrapper style-1">
                    <div class="tab-nav-wrapper">
                        <div  class="nav-tab  clearfix">
                            <div class="nav-tab-item active"><span><?php esc_html_e('Projects', 'nrgnetwork'); ?></span></div>
                            <div class="nav-tab-item "><span><?php esc_html_e('Appreciated', 'nrgnetwork'); ?></span></div>
                            <div class="nav-tab-item "><span><?php esc_html_e('Collections', 'nrgnetwork'); ?></span></div>
                            <div class="nav-tab-item "><span><?php esc_html_e('Followers', 'nrgnetwork'); ?></span></div>
                            <div class="nav-tab-item "><span><?php esc_html_e('Following', 'nrgnetwork'); ?></span></div>
                        </div>
                    </div>
                    <div class="tabs-content clearfix">
                                            ...
                                            <div class="col-ml-12 col-xs-6 col-sm-4 netauthor-item">
                                                <div class="be-post item-media">
                                                    <?php
                                                        ...
                                                        if( $user == get_current_user_id() ){
                                                            print '<a href="'.NRGnetwork_C::get_folio_edit_uri(get_the_ID()).'" class="folio-edit-uri">Edit</a>';
                                                        }
                                                        $post_status = get_post_status(get_the_id());
                                                        if( in_array($post_status, array('draft', 'pending')) ){
                                                            print '<a href="javascript:;" class="folio-post-status">'.$post_status.'</a>';
                                                        }
                                                    ?>
                                                    ...
                                                    <div class="author-post">
                                                        ...
                                                        <span>by <a href="<?php print NRGnetwork_C::get_author_uri($user); ?>"><?php the_author(); ?></a></span>
                                                    </div>
                            ...
                            <?php if( abs($posts_query->post_count)>8 ): ?>
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <div class="hidden" id="load_more_projects"><?php print NRGnetwork_C::encode($args); ?></div>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="tab-info">
                            <div class="tab-info-viewport">
                                <div class="row">
                                    <?php
                                        $liked_posts = NRGnetwork_C::get_liked_posts($user);
                                        // build query
                                        $args = array(
                                                        'post_type' => $network_post_type,
                                                        'posts_per_page' => 9,
                                            ...
                                            <div class="col-ml-12 col-xs-6 col-sm-4 netauthor-item">
                                                <div class="be-post item-media style-4">
                                                    ...
                                                    <div class="author-post clearfix">
                                                        ...
                                                        <span class="like-counter"><i class="fa fa-thumbs-o-up"></i> <?php print NRGnetwork_C::get_likes(); ?></span>
                                                    </div>
                                                </div>                                  
                                            </div>
                                        <?php endwhile;
                            ...
                            <?php if( abs($posts_query->post_count)>8 ): ?>
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        ...
                                        <div class="hidden" id="load_more_likes"><?php print NRGnetwork_C::encode($args); ?></div>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="tab-info">
                            ...
                            ?>
                                    <div class="collection">
                                        <h3 class="menu-article"><?php print isset($coll['name']) ? $coll['name'] : 'Collection'; ?></h3>
                                        <div class="collection-header">
                                            <span><i class="fa fa-user"></i>by <a href="<?php print NRGnetwork_C::get_author_uri($user); ?>"><?php print get_the_author_meta('user_nicename', $user); ?></a> </span>
                                            <span><i class="fa fa-file-text-o"></i> <?php print isset($coll['posts']) ? count($coll['posts']) : '0'; ?></span>
                                            <span class="collection-actions">
                                                <?php if( is_user_logged_in() && get_current_user_id()==$user ): ?>
                                                    <a href="javascript:;" class="coll_edit_action" data-nonce="<?php print esc_attr($nonce); ?>" data-id="<?php print esc_attr($coll['id']); ?>"><i class="fa fa-pencil"></i> <?php esc_html_e('Rename', 'nrgnetwork'); ?></a>
                                                    <a href="javascript:;" class="col_remove_action" data-nonce="<?php print esc_attr($nonce); ?>" data-id="<?php print esc_attr($coll['id']); ?>"><i class="fa fa-remove"></i> <?php esc_html_e('Rename', 'nrgnetwork'); ?></a>
                                                <?php endif; ?>
                                            </span>
                                        </div>
                                        <div class="collection-entry">
                                            <a href="<?php print NRGnetwork_C::get_author_collect_uri($user, $coll['id']); ?>" class="portfolio-link type-2 clearfix">
                                                <?php
                                                    $args = array(
                                                        'post_type' => $network_post_type,
                                                        'posts_per_page' => 5,
                                                    ...
                                                    while ( $posts_query->have_posts() ){
                                                        ...
                                                        if( has_post_thumbnail() ){
                                                            ...
                                                            print( NRGnetwork_C::image_filter($img) );
                                                        }
                                                    }
                                                    wp_reset_postdata();
                                                ?>

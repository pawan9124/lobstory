        ...
        <div class="row">
            <div class="col-xs-12 col-sm-9">
                <div class="blog-wrapper blog-list">
                        ...
                        <div class="blog-post be-large-post">
                            <div class="info-block clearfix">
                                <div class="be-large-post-align">
                                    <span><?php print NRGnetwork_C::get_like_link('<i class="fa fa-thumbs-o-up"></i> '.NRGnetwork_C::get_likes()); ?></span>
                            ...
                            <div class="be-large-post-align">
                                ...
                                <span class="be-text-tags clearfix">
                                    ...
                                    <div class="author-post"><?php print get_avatar( $post->post_author, 20 ); ?><span><?php esc_html_e('by ', 'nrgnetwork'); ?><a href="<?php the_permalink(); ?>"><?php the_author(); ?></a></span></div>
                                </span>
                                <div class="clear"></div>
                            </div>
                            <?php
                                if( has_post_thumbnail() ){
                                    ...
                                    print '<a class="post-preview post-image" href="'.esc_url(get_permalink()).'">
                                                '.$img.'
                                            </a>';
                                }
                            ?>
                    ...
                    <?php endwhile;
                        NRGnetwork_TPL::get_related_posts();

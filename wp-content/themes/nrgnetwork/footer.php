<!-- THE FOOTER -->
		<?php
		    if( NRGnetwork_Std::get_mod('footer')=='1'):
		    
		    switch (NRGnetwork_Std::get_mod('footer_widget_num')) {
		        case 1:
		            $col = 1;
		...
		<footer>
			<div class="footer_slider">
				<div class="swiper-container" data-autoplay="0" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="responsive" data-xs-slides="4" data-sm-slides="8" data-md-slides="14" data-lg-slides="19" data-add-slides="19">
		            <div class="swiper-wrapper">
		        		...
		        		?>
				            	<div class="swiper-slide active" data-val="0"><?php print get_avatar($user->ID, 76); ?></div>
		            	<?php endforeach; ?>
		            </div>
			...
			<div class="footer-main">
				<div class="container-fluid custom-container">
					<div class="row">	
						<?php 
		                    for ($i = 1; $i <= $col; $i++) {
		                        print "<div class='".$percent[$i - 1]." footer-column-$i'>";
			...
			<?php endif; ?>
			<?php if( NRGnetwork_Std::get_mod('sub-footer')=='1'): ?>
			<div class="footer-bottom">
				<div class="container-fluid custom-container">
					<div class="col-md-12 footer-end clearfix">
						<div class="left"><?php print NRGnetwork_Std::get_mod('copyright_content'); ?></div>
						<div class="right">
							<?php
		                    wp_nav_menu( array(
		                        'menu_id'           => '',
					...
					<div class="col-md-8 col-md-push-2 col-lg-6 col-lg-push-3 large-popup-content">
						<div class="row">
							<div class="col-md-12">
								...
								<h5 class="large-popup-title"><?php esc_attr_e('Login', 'nrgnetwork'); ?></h5>
							</div>
							<form action="<?php print esc_url(wp_login_url(home_url('/'))); ?>" method="post" class="popup-input-search">
							<div class="col-md-6"><input class="input-signtype" name="log" type="text" required="" placeholder="<?php esc_attr_e('Username', 'nrgnetwork'); ?>"></div>
							<div class="col-md-6"><input class="input-signtype" name="pwd" type="password" required="" placeholder="<?php esc_attr_e('Password', 'nrgnetwork'); ?>"></div>
							<div class="col-xs-6">
								<div class="be-checkbox">
									...
									<span class="large-popup-text"><?php esc_attr_e('Stay Signed In', 'nrgnetwork'); ?></span>
								</div>
								<a href="<?php print wp_lostpassword_url(); ?>" title="Lost Password" class="link-large-popup"><?php esc_attr_e('Forgot Password?', 'nrgnetwork'); ?></a>
								<a href="javascript:;" class="be-register link-large-popup"><?php esc_attr_e('Sign Up Now', 'nrgnetwork'); ?></a>
							</div>
							<div class="col-xs-6 for-signin"><input type="submit" class="be-popup-sign-button" value="<?php esc_attr_e('SIGN IN', 'nrgnetwork'); ?>"></div>
							</form>
						</div>
					</div>
				</div>
					...
					<div class="col-md-10 col-md-push-1 col-lg-8 col-lg-push-2 large-popup-content">
						<div class="row">
							...
							<form class="popup-input-search" method="post" id="reg_frontend_form" autocomplete="off">
								...
								<div class="col-md-6"><input class="input-signtype" type="text" name="reg_fname" required="" placeholder="<?php esc_attr_e('First Name', 'nrgnetwork'); ?>" value=""></div>
								<div class="col-md-6"><input class="input-signtype" type="text" name="reg_lname" required="" placeholder="<?php esc_attr_e('Last Name', 'nrgnetwork'); ?>" value=""></div>
								<div class="col-md-6"><input class="input-signtype" type="text" id="reg_username" name="reg_username" required="" placeholder="<?php esc_attr_e('Username', 'nrgnetwork'); ?>" value=""></div>
								<div class="col-md-6"><input class="input-signtype" type="email" name="reg_email" required="" placeholder="<?php esc_attr_e('Email', 'nrgnetwork'); ?>" value=""></div>
								<div class="col-md-6"><input class="input-signtype" type="password" name="reg_pass" required="" placeholder="<?php esc_attr_e('Password', 'nrgnetwork'); ?>" value="" autocomplete="off"></div>
								<div class="col-md-6">
									<div class="be-custom-select-block">
									<select name="reg_country" class="be-custom-select">
										<option value="" disabled selected><?php esc_attr_e('Country', 'nrgnetwork'); ?></option>
										<?php
											$countries = NRGnetwork_C::get_countries();
								...
								<div class="col-md-12 be-date-block">
									<span class="large-popup-text"><?php esc_attr_e('Date of birth', 'nrgnetwork'); ?></span>
									<div class="be-custom-select-block mounth">
										<select name="reg_birth_month" class="be-custom-select">
											<option value="" disabled selected><?php esc_attr_e('Month', 'nrgnetwork'); ?></option>
									...
									<div class="be-custom-select-block">
										<select name="reg_birth_day" class="be-custom-select">
											<option value="" disabled selected><?php esc_attr_e('Day', 'nrgnetwork'); ?></option>
											<?php
												for($i=1; $i<=31; $i++){
									...
									<div class="be-custom-select-block">
										<select name="reg_birth_year" class="be-custom-select">
											<option value="" disabled selected><?php esc_attr_e('Year', 'nrgnetwork'); ?></option>
											<?php
												for($i=2010; $i>1900; $i--){
													print "<option>$i</option>";
												}
								...
								<div class="col-md-6">
									<div class="be-checkbox">
										...
										<span class="large-popup-text"><?php print NRGnetwork_Std::get_mod('terms_of_use'); ?></span>
									</div>
									<div class="be-checkbox">
										<label class="check-box"><input class="checkbox-input" type="checkbox" value="1" name="reg_subs" /> <span class="check-box-sign"></span></label>
										<span class="large-popup-text"><?php esc_attr_e('Send me notifications', 'nrgnetwork'); ?></span>
									</div>
								</div>
					...
					<div class="col-md-10 col-md-push-1 col-lg-8 col-lg-push-2 large-popup-content">
						<div class="row">
							...
							<form class="popup-input-search" method="post" id="frontend_mail_form">
								...
								<div class="col-md-6"><input class="input-signtype" type="text" name="msg_fname" required="" placeholder="<?php esc_attr_e('First Name', 'nrgnetwork'); ?>"></div>
								<div class="col-md-6"><input class="input-signtype" type="text" name="msg_lname" required="" placeholder="<?php esc_attr_e('Last Name', 'nrgnetwork'); ?>"></div>
								<div class="col-md-6">
									<div class="be-custom-select-block">
								...
								<div class="col-md-6"><input class="input-signtype" type="email" name="msg_mail" required="" placeholder="<?php esc_attr_e('Email', 'nrgnetwork'); ?>"></div>
								<div class="col-md-12"><textarea class="message-area" name="msg_content" placeholder="<?php esc_attr_e('Message', 'nrgnetwork'); ?>"></textarea></div>
								<div class="col-md-12 for-signin"><input type="submit" class="be-popup-sign-button" value="<?php esc_attr_e('SEND', 'nrgnetwork'); ?>"></div>
							</form>
						</div>
					</div>
				</div>
			...
			<div id="tpl-add2collection">
				<div class="add2col-wrapper">
					...
					<ul class="add2col-list">
						<li><span><?php esc_html_e('Loading Collection...', 'nrgnetwork'); ?></span></li>
					</ul>
				</div>
			</div>
			<div id="tpl-custom-section">

<?php
class NRGnetwork_MetaPage extends NRGnetwork_RenderMeta{
    function __construct(){
        ...
        if( NRGnetwork_Std::admin_post_type()=="page" ){
    ...
    public function items(){
        global $nrgnetwork_sliders, $post;
        // init One Page menus
        ...
        // Google Font Options
        include_once NRGnetwork_Std::file_require(get_template_directory() . '/framework/functions/google-fonts.php');
        ...
        foreach ($nrgnetwork_google_fonts as $font) {

<?php
class NRGnetwork_MetaPost extends NRGnetwork_RenderMeta{
    ...
    public function print_scripts_post($hook) {
        if( NRGnetwork_Std::admin_post_type()!='post' ){
            return;
        }
    }
                ...
                <?php
                    ...
                    if ( $attachments )
                        foreach ( $attachments as $attachment_id ) {
                            print '<li class="image" data-attachment_id="' . $attachment_id . '">

<?php
class NRGnetwork_MetaPortfolio extends NRGnetwork_RenderMeta{
    function __construct(){
        ...
        if( NRGnetwork_Std::admin_post_type()=="portfolio" ){

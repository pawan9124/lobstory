        ...
        <div class="row">
            <div class="col-xs-12 col-md-3 left-feild">
                <div id="scrollspy">
                    <div class="be-vidget back-block">
                        <a class="btn full color-1 size-1 hover-1" href="<?php print NRGnetwork_C::get_author_uri($user); ?>"><i class="fa fa-chevron-left"></i><?php esc_html_e('back to profile', 'nrgnetwork'); ?></a>
                    </div>
                    <div class="be-vidget hidden-xs hidden-sm">
                        <h3 class="letf-menu-article"><?php esc_html_e('Choose Category', 'nrgnetwork'); ?></h3>
                            ...
                            <ul class="ul nav">
                                ...
                                <?php
                                    foreach ($custom_section as $item) {
                                        print '<li><a href="#'.$item['id'].'">'.$item['title'].'</a></li>';
                                    }
                                ?>
                            </ul>
                        </div>
                    </div>
                    <a class="btn full color-1 size-1 hover-1" href="javascript:;" id="save-profile"><i class="fa fa-check"></i><?php esc_html_e('save profile', 'nrgnetwork'); ?></a>
                </div><!-- #scollspy -->
            </div>
            <div class="col-xs-12 col-md-9 _editor-content_">
                    ...
                    <div class="be-large-post">
                        ...
                        <div class="be-large-post-align">
                            <div class="be-change-ava">
                                <a class="be-ava-user style-2 img-round" id="user-avatar" href="javascript:;"><?php print get_avatar( $user, 115 ); ?></a>
                            ...
                            <div class="row">
                                <div class="input-col col-xs-12 col-sm-6">
                                    <div class="form-group fg_icon focus-2">
                                        ...
                                        <input class="form-input cs-fname" type="text" value="<?php print get_the_author_meta('first_name', $user); ?>">
                                    </div>                          
                                </div>
                                <div class="input-col col-xs-12 col-sm-6">
                                    <div class="form-group focus-2">
                                        <div class="form-label"><?php esc_html_e('Last Name', 'nrgnetwork'); ?></div>                                 
                                        <input class="form-input cs-lname" type="text" value="<?php print get_the_author_meta('last_name', $user); ?>">
                                    </div>                              
                                </div>
                                <div class="input-col col-xs-12">
                                    <div class="form-group focus-2">
                                        <div class="form-label"><?php esc_html_e('Occupation', 'nrgnetwork'); ?></div>
                                        <input class="form-input cs-occupation" type="text" value="<?php print get_user_meta($user, 'cs_occupation', true); ?>" placeholder="<?php esc_html_e('UI/UX, Web Design, Art Direction', 'nrgnetwork'); ?>">
                                    </div>                              
                                </div>
                                <div class="input-col col-xs-12">
                                    <div class="form-group focus-2">
                                        <div class="form-label"><?php esc_html_e('Company', 'nrgnetwork'); ?></div>                                   
                                        <input class="form-input cs-company" type="text" value="<?php print get_user_meta($user, 'cs_company', true); ?>" placeholder="<?php esc_html_e('Company', 'nrgnetwork'); ?>">
                                    </div>                              
                                </div>
                                <div class="input-col col-xs-12 col-sm-6">
                                    <div class="form-group focus-2">
                                        ...
                                        <div class="be-drop-down icon-none">
                                            <span class="be-dropdown-content"> <?php print get_user_meta($user, 'cs_country', true); ?> </span>
                                            <input class="form-input cs-country" type="hidden" value="<?php print get_user_meta($user, 'cs_country', true); ?>">
                                            <ul class="drop-down-list">
                                                <?php
                                                    $countries =NRGnetwork_C::get_countries();
                                                    foreach ($countries as $val) {
                                                        print "<li><a href='javascript:;'>$val</a></li>";
                                                    }
                                                ?>
                                            </ul>
                                        </div>
                                ...
                                <div class="input-col col-xs-12 col-sm-6">
                                    <div class="form-group focus-2">
                                        ...
                                        <input class="form-input cs-city" type="text" value="<?php print get_user_meta($user, 'cs_city', true); ?>" placeholder="<?php esc_html_e('City name', 'nrgnetwork'); ?>">
                                    </div>
                                </div>
                                <div class="input-col col-xs-12">
                                    <div class="form-group focus-2">
                                        <div class="form-label"><?php esc_html_e('Website URL', 'nrgnetwork'); ?></div>
                                        <input class="form-input cs-website" type="text" value="<?php print get_user_meta($user, 'user_url', true); ?>">
                                    </div>                              
                                </div>                              
                            </div>
                        </div>
                    ...
                    <div class="be-large-post">
                        ...
                        <div class="be-large-post-align">
                            <div class="social-input form-group focus-2">
                                ...
                                <div class="s_input">
                                    <input class="form-input cs-socials" type="text" placeholder="http://facebook.com/#user" value="<?php print esc_attr($cs_socials['facebook']); ?>">
                                </div>
                            </div>
                            <div class="social-input form-group focus-2">
                                <div class="s_icon">
                                ...
                                <div class="s_input">
                                    <input class="form-input cs-socials" type="text" placeholder="http://twitter.com/#user" value="<?php print esc_attr($cs_socials['twitter']); ?>">
                                </div>
                            </div>
                            <div class="social-input form-group focus-2">
                                <div class="s_icon">
                                ...
                                <div class="s_input">
                                    <input class="form-input cs-socials" type="text" placeholder="http://googleplus.com/#user" value="<?php print esc_attr($cs_socials['google']); ?>">
                                </div>
                            </div>
                            <div class="social-input form-group focus-2">
                                <div class="s_icon">
                                ...
                                <div class="s_input">
                                    <input class="form-input cs-socials" type="text" placeholder="http://pinterest.com/#user" value="<?php print esc_attr($cs_socials['pinterest']); ?>">
                                </div>
                            </div>
                            <div class="social-input form-group focus-2">
                                <div class="s_icon">
                                ...
                                <div class="s_input">
                                    <input class="form-input cs-socials" type="text" placeholder="http://instagram.com/#user" value="<?php print esc_attr($cs_socials['instagram']); ?>">
                                </div>
                            </div>
                            <div class="social-input form-group focus-2">
                                <div class="s_icon">
                                ...
                                <div class="s_input">
                                    <input class="form-input cs-socials" type="text" placeholder="http://linkedin.com/#user" value="<?php print esc_attr($cs_socials['linkedin']); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="input-col col-xs-12">
                                    <div class="form-group focus-2">
                                        ...
                                        <textarea class="form-input cs-description" required="" placeholder="<?php esc_html_e('Something about you', 'nrgnetwork'); ?>"><?php print get_the_author_meta('description', $user); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>                      
                ...
                <?php foreach ($custom_section as $item): ?>
                    <div class="affix-block custom-section-block saved-section" id="<?php print esc_attr($item['id']); ?>">
                        <div class="be-large-post">
                            <div class="info-block style-2">
                                <div class="be-large-post-align">
                                ...
                                <div class="row">
                                    <div class="input-col col-xs-12">
                                        <div class="form-group focus-2">
                                            ...
                                            <input class="form-input cs-input" type="text" value="<?php print esc_attr($item['title']); ?>">
                                        </div>
                                    </div>
                                    <div class="input-col col-xs-12">
                                        <div class="form-group focus-2">

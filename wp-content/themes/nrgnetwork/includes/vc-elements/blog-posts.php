...
class WPBakeryShortCode_Tt_Blog_Posts extends WPBakeryShortCode {
    protected function content( $atts, $content = null){
        ...
        while ( $posts_query->have_posts() ) {
            ...
            $excerpt = NRGnetwork_TPL::clear_urls( wp_trim_words( wp_strip_all_tags(strip_shortcodes(get_the_content())), 30 ) );
            $comments = get_comments_number('0', '1', '%');
            $postclass = implode(' ',get_post_class('blog-item'));
            if($blog_type == 'grid') {
                $media = NRGnetwork_TPL::get_post_media('nrgnetwork-blog-grid-thumb');
                        ...
                        <div class='blog-post'>
                            ...
                            <div class='post-desc'>
                                ...
                                <div class='info-block'>
                                    ".NRGnetwork_C::get_like_link('<i class="fa fa-thumbs-o-up"></i> '.NRGnetwork_C::get_likes()).
                                    "<a href='". get_permalink() ."'><i class='fa fa-eye'></i> ". NRGnetwork_C::get_views() ."</a>
        ...
        if( $show_pagination == 'yes' ) {
            ob_start();
            NRGnetwork_TPL::pagination($posts_query);
...
vc_map( array(
    ...
    "base" => 'tt_blog_posts',
    "icon" => "icon-wpb-nrgthemes",
    "content_element" => true,
    "category" => esc_html__('NRGnetwork', 'nrgnetwork'),
    'params' => array(
        array(
            "type" => "dropdown",

...
class WPBakeryShortCode_Tt_Portfolio extends WPBakeryShortCode {
    protected function content( $atts, $content = null){
		...
		print "<div class='row _post-container_ $extra_class'>";
        $args = array(
                    ...
                    <?php 
                        if($show_excerpt == 'yes'): 
                            ...
                            <?php 
                                ...
                                print '<span>' . nrgnetwork_showBrief( strip_shortcodes(get_the_excerpt()), $excerpt_count) . '</span>';
                            endif;
                        endif;
                    ?>
                    <div class="author-post">
                        <?php print get_avatar( $post_author, 20 ); ?>
                        <span>by <a href="<?php print NRGnetwork_C::get_author_uri($post_author); ?>"> <?php the_author(); ?></a></span>
                    </div>

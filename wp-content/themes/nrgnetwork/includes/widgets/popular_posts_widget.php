<?php
class NRGnetwork_PopularPostsWidget extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'popular_posts', 'description' => __( 'Popular Posts.', 'nrgnetwork') );
    ...
    function widget($args, $instance) {
        ...
        while (have_posts()) : the_post();
            $thumb = '';
            $excerpt = NRGnetwork_TPL::clear_urls( wp_trim_words( wp_strip_all_tags(do_shortcode(get_the_content())), 10 ) );
                print '<div class="be-post style-2">
...
add_action('widgets_init', create_function('', 'return register_widget("NRGnetwork_PopularPostsWidget");'));
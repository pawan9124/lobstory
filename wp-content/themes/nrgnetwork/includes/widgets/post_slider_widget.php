<?php
class NRGnetwork_PostSliderWidget extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'post_slider', 'description' => __( 'Posts show in carousel.', 'nrgnetwork') );
    ...
    function widget($args, $instance) {
        ...
        print '<div class="swiper-container" data-autoplay="5000" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
...
add_action('widgets_init', create_function('', 'return register_widget("NRGnetwork_PostSliderWidget");'));
...
if( !nrgnetwork_editmode() ){
    $post_id = 0;
}
function nrgnetwork_editmode(){
...
<div id="content-block" class="work-box">
    ...
    <div class="work-area">
        <div class="cover-popup">
            <div class="cover-box">
                <form action="">
                    <div class="tt-frontend-cover-img" data-img="<?php print nrgnetwork_editmode() ? get_post_thumbnail_id($post_id) : ''; ?>">
                        <img src="<?php print nrgnetwork_editmode() ? wp_get_attachment_url( get_post_thumbnail_id($post_id), 'full' ) : get_template_directory_uri().'/img/blank.png'; ?>">
                    </div>
                    <textarea placeholder="<?php esc_html_e('Title Project', 'nrgnetwork'); ?>"><?php print nrgnetwork_editmode() ? get_the_title() : esc_html__('Portfolio Title', 'nrgnetwork'); ?></textarea>
                </form>
                ...
                <div class="setting-form">
                    <form>
                        <div class="form-group">
                            ...
                            <select id="tt_frontend_cats" class="form-control" multiple="multiple">
                                <?php
                                    ...
                                    if( nrgnetwork_editmode() ){
                                        $cur_cats = NRGnetwork_TPL::get_folio_cats($post_id);
                                    ...
                                    foreach ($terms as $term) {
                                        ...
                                        print '<option value="'.$term->term_id.'" '.$selected.'>'.$term->name.'</option>';
                                    }
                                ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea id="tt_frontend_tags">
                                <?php
                                     if( nrgnetwork_editmode() ){
                                        $folio_tags = array();
                                        $cur_tags = NRGnetwork_TPL::get_folio_cats($post_id, true);
                                        foreach ($cur_tags as $tag) {
                                            $folio_tags[] = $tag['title'];
                                        }
                                        print implode(",", $folio_tags);
                                     }
                                ?>
                            </textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea id="tt_frontend_excerpt"><?php print nrgnetwork_editmode() ? get_the_excerpt() : ''; ?></textarea>
                        </div>
                    </form>
                </div>
                <div class="setting-block">
                    <div class="settings-row cfix">
                        <div class="left settings-label"><?php print NRGnetwork_Std::get_mod('meta_field1'); ?>:</div>
                        <div class="left settings-option">
                            <div class="settings-sub-option cfix">
                                <div class="left settings-note st-label">
                                    <?php if( nrgnetwork_editmode() ): ?>
                                        <span class="grey"><?php print NRGnetwork_Std::getmeta('extra_brand'); ?> ...</span>
                                        <input type="hidden" id="tt_extra_brand" value="<?php print NRGnetwork_Std::getmeta('extra_brand'); ?>">
                                    <?php else: ?>
                        ...
                        <div class="left settings-label"><?php print NRGnetwork_Std::get_mod('meta_field2'); ?>:</div>
                        <div class="left settings-option">
                            <div class="settings-sub-option cfix">
                                <div class="left settings-note st-label">
                                    <?php if( nrgnetwork_editmode() ): ?>
                                        <span class="grey"><?php print NRGnetwork_Std::getmeta('extra_tools'); ?> ...</span>
                                        <input type="hidden" id="tt_extra_tools" value="<?php print NRGnetwork_Std::getmeta('extra_tools'); ?>">
                                    <?php else: ?>
                                        <span class="grey"><?php esc_html_e('example1, example2...', 'nrgnetwork'); ?></span>
                        ...
                        <div class="left settings-label"><?php print NRGnetwork_Std::get_mod('meta_field3'); ?>:</div>
                        <div class="left settings-option">
                            <div class="settings-sub-option cfix">
                                <div class="left settings-note st-label">
                                    <?php if( nrgnetwork_editmode() ): ?>
                                        <span class="grey"><?php print NRGnetwork_Std::getmeta('extra_color'); ?> <span class="<?php print NRGnetwork_Std::getmeta('extra_color'); ?>">...</span></span>
                                        <input type="hidden" id="tt_extra_color" value="<?php print NRGnetwork_Std::getmeta('extra_color'); ?>">
                                    <?php else: ?>
                        ...
                        <div class="left settings-label"><?php print NRGnetwork_Std::get_mod('meta_field4'); ?>:</div>
                        <div class="left settings-option">
                            <div class="settings-sub-option cfix">
                                <div class="left settings-note st-label">
                                    <?php if( nrgnetwork_editmode() ): ?>
                                        <span class="grey"><?php print NRGnetwork_Std::getmeta('extra_copyright'); ?> ...</span>
                                        <input type="hidden" id="tt_extra_copyright" value="<?php print NRGnetwork_Std::getmeta('extra_copyright'); ?>">
                                    <?php else: ?>
                                        <span class="grey"><?php esc_html_e('example1, example2...', 'nrgnetwork'); ?></span>
                            ...
                            <label>
                                <?php if( nrgnetwork_editmode() ): ?>
                                    <input type="checkbox" id="tt_extra_adult" value="adult" <?php
                                        $adult = NRGnetwork_Std::getmeta('extra_adult');
                                        if( $adult=='adult' ){
                                            print 'checked';
                                        }
                                    ?>> Adult Content
            ...
            <div class="row">
                <div class="col-xs-12 col-md-3 st-col left-feild">
                    <div class="be-vidget behance-style" >
                        <h3 class="letf-menu-article"><?php esc_html_e('ADD MEDIA', 'nrgnetwork'); ?></h3>
                    ...
                    <div class="be-vidget  behance-style">
                        <h3 class="letf-menu-article"><?php esc_html_e('CUSTOMIZE DESIGN', 'nrgnetwork'); ?></h3>
                        <div class="creative_filds_block">
                            <ul class="ul nav b-work-list b-work-list-no">
                                <li ><a class="open-custom" href="#"><?php esc_html_e('Dividers & Spacing', 'nrgnetwork'); ?> <i class="fa fa-chevron-down"></i></a>
                                    <div class="inner-filter-info">
                                        <?php $cs_divider = nrgnetwork_editmode() ? NRGnetwork_Std::getmeta('cs_divider', $post_id) : 'none'; ?>
                                        <div class="inner-filter-inner inner-d">
                                            <input  type="radio" id="d1" class="ch" name="divider" value="none" <?php print esc_attr( in_array($cs_divider, array('solid','dashed','dotted')) ? '' : 'checked' ); ?>/>
                                            <label for="d1"><?php esc_html_e('No Divider', 'nrgnetwork'); ?></label>
                                        </div>
                                        <div class="inner-filter-inner inner-d">
                                            <div class="label-box ">
                                                <input  type="radio" id="d2" class="ch" name="divider" value="solid" <?php print esc_attr( $cs_divider=='solid' ? 'checked' : '' ); ?>/>
                                                <label for="d2"></label>
                                            </div>
                                            <div class="label-box">
                                                <input  type="radio" id="d3" class="ch" name="divider" value="dashed" <?php print esc_attr( $cs_divider=='dashed' ? 'checked' : '' ); ?>/>
                                                <label for="d3"></label>
                                            </div>
                                            <div class="label-box">
                                                <input  type="radio" id="d4" class="ch" name="divider" value="dotted" <?php print esc_attr( $cs_divider=='dotted' ? 'checked' : '' ); ?>/>
                                                <label for="d4"></label>
                                            </div>
                                        </div>
                                        <div class="inner-filter-inner inner-filter-inner-mod">
                                            ...
                                            <div class="range">
                                                ...
                                                <input type="text" class="amount" id="amount" readonly value="<?php print nrgnetwork_editmode() ? NRGnetwork_Std::getmeta('cs_space', $post_id) : '0'; ?>">
                                            </div>
                                        </div>
                                        <div class="inner-filter-inner inner-filter-inner-mod">
                                            ...
                                            <div class="range">
                                                ...
                                                <input type="text" class="amount" id="amount-h" readonly value="<?php print nrgnetwork_editmode() ? NRGnetwork_Std::getmeta('cs_padding', $post_id) : '0'; ?>">
                                            </div>
                                        </div>
                                        <div class="inner-filter-inner">
                                            <span><?php esc_html_e('Color', 'nrgnetwork'); ?></span> <input id="divider_color" class="color-i no-alpha" data-colorMode="rgba" value="<?php print nrgnetwork_editmode() ? NRGnetwork_Std::getmeta('cs_color', $post_id) : ''; ?>" style="color: rgb(255, 255, 55); background-color: rgb(255, 255, 255);">
                                        </div>
                                    </div>
                                </li>
                                <li ><a class="open-custom" href="#"><?php esc_html_e('Background', 'nrgnetwork'); ?> <i class="fa fa-chevron-down"></i></a>
                                    <div class="inner-filter-info">
                                        <div class="inner-filter-inner ">
                                            <span><?php esc_html_e('Color', 'nrgnetwork'); ?></span> <input id="bg_color" class="color-i no-alpha" data-colorMode="rgba" value="<?php print nrgnetwork_editmode() ? NRGnetwork_Std::getmeta('cs_bg', $post_id) : ''; ?>" style="color: rgb(255, 255, 255); background-color: rgb(255, 255, 255);">
                                        </div>
                                        <div class="inner-filter-inner ">
                                            <span><?php esc_html_e('Text', 'nrgnetwork'); ?>&nbsp;&nbsp;</span> <input id="text_color" class="color-i no-alpha" data-colorMode="rgba" value="<?php print nrgnetwork_editmode() ? NRGnetwork_Std::getmeta('cs_text', $post_id) : ''; ?>" style="color: rgb(255, 255, 255); background-color: rgb(255, 255, 255);">
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <?php
                            ...
                            ?>
                                <a href="javascript:;" class="btn btn-danger" id="btn_remove_project" data-post="<?php print esc_attr($post_id); ?>" data-nonce="<?php print esc_attr($nonce); ?>">
                ...
                <div class="col-xs-12 col-md-9 _editor-content_">
                    <div class="sec"  data-sec="basic-information">
                        <input type="hidden" id="post_id" value="<?php print esc_attr($post_id); ?>">
                        <div class="be-large-post large-area" id="tt_frontend_container">
                            <div class="info-block style-2">
                                <div class="be-large-post-align ">
                                    <h3 class="info-block-label" contenteditable="true" id="tt_fontend_title"><?php print nrgnetwork_editmode() ? get_the_title() : esc_html__('Portfolio name', 'nrgnetwork'); ?></h3>
                                </div>
                            </div>

            ...
            <div class="col-xs-12 col-lg-10 col-lg-offset-1">
                            ...
                            <div class="tabs-content clearfix">
                                <div class="tab-info chart-info  active">
                                    <div class="stat-chartjs">
                                        ...
                                        <div class="chart-data" data-label="<?php esc_attr_e('Weekly Profile Views', 'nrgnetwork'); ?>">
                                            <?php
                                                $data = array();
                                                ...
                                                $meta_data = NRGnetwork_C::decode($meta_val);
                                ...
                                <div class="tab-info chart-info">
                                    <div class="stat-chartjs">
                                        <div class="chart-viewport" style="height: 300px; width: 100%;"></div>
                                        <div class="chart-data" data-label="<?php esc_attr_e('Weekly Appreciations', 'nrgnetwork'); ?>">
                                            <?php
                                                $data = array();
                                                $data[] = array('label'=>esc_attr__('Mon', 'nrgnetwork'), 'y'=>0);
                                                $data[] = array('label'=>esc_attr__('Tue', 'nrgnetwork'), 'y'=>0);
                                ...
                                <div class="tab-info chart-info">
                                    <div class="stat-chartjs">
                                        <div class="chart-viewport" style="height: 300px; width: 100%;"></div>
                                        <div class="chart-data" data-label="<?php esc_attr_e('Weekly Comments', 'nrgnetwork'); ?>">
                                            <?php
                                                $data = array();
                                                $data[] = array('label'=>esc_attr__('Mon', 'nrgnetwork'), 'y'=>0);
                                                $data[] = array('label'=>esc_attr__('Tue', 'nrgnetwork'), 'y'=>0);
                                ...
                                <div class="tab-info chart-info">
                                    <div class="stat-chartjs">
                                        <div class="chart-viewport" style="height: 300px; width: 100%;"></div>
                                        <div class="chart-data" data-label="<?php esc_attr_e('Weekly Project Views', 'nrgnetwork'); ?>">
                                            <?php
                                                $data = array();
                                                $data[] = array('label'=>esc_attr__('Mon', 'nrgnetwork'), 'y'=>0);
                                                $data[] = array('label'=>esc_attr__('Tue', 'nrgnetwork'), 'y'=>0);
                ...
                <div class="statistic-block">
                    <div class="tab-wrapper style-3 color-2">
                        <div class="tab-nav-wrapper">
                            <div  class="nav-tab  clearfix">
                                <div class="nav-tab-item active"><span><?php esc_html_e('Receives', 'nrgnetwork'); ?></span></div>
                                <div class="nav-tab-item "><span><?php esc_html_e('Given', 'nrgnetwork'); ?></span></div>
                            </div>
                        </div>
                        <div class="tabs-content clearfix">
                                    ...
                                    <div class="row no-padding">
                                        <div class="stat-item col-xs-12 col-sm-3">
                                            <div class="stat-entry">
                                                <img src="<?php print get_template_directory_uri(); ?>/img/stat_1.png" alt="">
                                                <div class="stat-number">
                                                    <?php
                                                        $total_views = get_user_meta( $user, 'netproject_who_view', true );
                                                        print abs($total_views);
                                                    ?>
                                                </div>
                                        ...
                                        <div class="stat-item col-xs-12 col-sm-3">
                                            <div class="stat-entry">
                                                <img src="<?php print get_template_directory_uri(); ?>/img/stat_2.png" alt="">
                                                <div class="stat-number">
                                                    <?php
                                        ...
                                        <div class="stat-item col-xs-12 col-sm-3">
                                            <div class="stat-entry">
                                                <img src="<?php print get_template_directory_uri(); ?>/img/stat_4.png" alt="">
                                                <div class="stat-number">
                                                    <?php
                                ...
                                <thead>
                                  <tr>
                                    ...
                                    <th class="col-xs-1 text-center">
                                        <img width="18px" src="<?php print get_template_directory_uri(); ?>/img/stat_1.png" alt="">
                                    </th>
                                    <th class="col-xs-1 text-center">
                                        <img width="18px" src="<?php print get_template_directory_uri(); ?>/img/stat_2.png" alt="">
                                    </th>
                                    <th class="col-xs-1 text-center">
                                        <img width="18px" src="<?php print get_template_directory_uri(); ?>/img/stat_3.png" alt="">
                                    </th>
                                            ...
                                            <tr>
                                                <td class="col-xs-4">
                                                    <div class="t_project clearfix">
                                                        <a href="<?php the_permalink(); ?>"><?php print($img); ?></a>
                                                        <div class="t_project-desc">
                                                            <a class="t_project-title" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                                            <div class="t_project-date"><i class="fa fa-clock-o"></i> <?php print get_the_date('M d, Y'); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <?php
                                                        $liked_authors_data = NRGnetwork_Std::getmeta('post_likes_data');
                                                        $liked_authors = NRGnetwork_C::decode($liked_authors_data);
                                                        $folio_likes += $liked_authors;
                                                        if( !empty($liked_authors) ){
                                                            $usr_index = 0;
                                                            foreach ($liked_authors as $val) {
                                                                print '<a class="t_project_icon img-round" href="'.NRGnetwork_C::get_author_uri($val).'">'.get_avatar($val, 40).'</a>';
                                                                $usr_index++;
                                                                if( $usr_index>3 ){
                                                                    break;
                                                                }
                            ...
                            ?>
                                    <div class="col-xs-12 col-sm-3">
                                        <div class="appreciator clearfix">
                                            <a href="<?php print NRGnetwork_C::get_author_uri($usr); ?>">
                                                <?php
                                            ...
                                            <div class="appreciator-desc">
                                                <div class="appreciator-title"><?php print get_the_author_meta('display_name', $usr); ?></div>
                                                <div class="appreciator-text">
                                                    <?php
                                                        print count( array_keys( $folio_likes, $usr ));
                                                        esc_html_e('Appreciations', 'nrgnetwork');
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-3">
                                        <div class="appreciator clearfix">
                                            ...
                                            <div class="appreciator-desc">
                                                ...
                                                <div class="appreciator-text">
                                                    <?php
                                                        print count( array_keys( $folio_comments, $usr ));
                                                        esc_html_e('Comments', 'nrgnetwork');
                                                    ?>
                                                </div>
                                            </div>
                                        </div>

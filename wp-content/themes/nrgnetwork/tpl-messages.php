...
if( function_exists('bp_message_threads') ): ?>
<!-- MAIN CONTENT -->
        ...
        <div class="container be-detail-container">
                ...
                if( isset($_POST['net_msg_to'], $_POST['net_msg_content']) && !empty($_POST['net_msg_to']) && !empty($_POST['net_msg_content']) ){
                    ...
                    if( $to_user ){
                        ...
                        $thread_id  = messages_new_message( array(
                            ...
                            'subject'    => esc_html__('You have a message from:', 'nrgnetwork') . get_the_author_meta('display_name', $user),
                            'content'    => $msg
                        ) );
                        ...
                        print '<input type="hidden" class="new_message_sent_field" value="1">';
                    } else {
                ?>
                        <div class="row">
                            <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-5 left-feild">
                    <a href="<?php print NRGnetwork_C::get_author_uri($user); ?>" class="btn color-4 size-1 hover-7"><i class="fa fa-chevron-left"></i> <?php esc_html_e('back to profile', 'nrgnetwork'); ?></a>
                    ...
                    <form id="msg-form-entry">
                        <div class="noto-header clearfix">
                            ...
                            <div class="stat-sort be-drop-down">
                                <span class="be-dropdown-content1"><?php esc_html_e('actions', 'nrgnetwork'); ?></span>
                                <ul class="drop-down-list">
                                    <li><a href="javascript:;" id="net_msg_remove_handler"><?php esc_html_e('Delete', 'nrgnetwork'); ?></a></li>
                                </ul>
                            </div>
                        </div>
                        <?php
                        ...
                        ?>
                                <div class="noto-entry style-3 msg-entry <?php print bp_message_thread_has_unread()=='1' ? 'unread' : ''; ?>">
                                        ...
                                        <div class="noto-text">
                                            <div class="noto-text-top">
                                                <span class="noto-name">
                                                    <a href="javascript:;"><?php print bp_core_get_user_displayname( $messages_template->thread->last_sender_id ); ?></a>
                                                </span>
